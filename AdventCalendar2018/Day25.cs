...
namespace AdventCalendar2018
{
    public static class Day25
    {
        ...
        private static IList<Star> Parse(string empty)
        {
            ...
            foreach (var line in lines)
            {
                ...
                result.Add(new Star(fields[0], fields[1], fields[2], fields[3]));   
            }
        ...
        private class Coord
        {
            ...
            protected Coord(int x, int y, int z, int t)
            {
                this.x = x;
                this.y = y;
                this.z = z;
            ...
            {
                return $"{nameof(x)}: {x}, {nameof(y)}: {y}, {nameof(z)}: {z}, {nameof(t)}: {t}";
            }
        }

        private class Star: Coord
        {
            public Star(int x, int y, int z, int t) : base(x, y, z, t)
            {
            }
        ...
        private class Constellation
        {
            ...
            private bool Equals(Constellation other)
            {
                return id == other.id;
            }
            ...
            public override string ToString()
            {
                return $"{nameof(id)}: {id}, {stars.Count} stars.";
            }
        }
